...
const clients: Client[] = [
  ...
  { name: 'Toshiba Software  India Pvt Ltd', initials: 'AMD', logo: '/img/clients/Toshiba_Software.webp', color: '#b91c1c', sector: 'Corporate' },
  ...
  { name: 'Honeywell Aerospace', initials: 'FOS', logo: '/img/clients/Honeywell_Aerospace.webp', color: '#92400e', sector: 'Corporate' },
  ...
  { name: 'Prestige Group', initials: 'PRE', logo: '/img/clients/prestige.webp', color: '#0e7490', sector: 'Builder' },
  { name: 'Centrix Interiors PVT Ltd', initials: 'PRE', logo: '/img/clients/Centrix_Interiors.webp', color: '#0e7490', sector: 'Builder' },
